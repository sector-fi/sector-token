...
// from https://github.com/Gearbox-protocol/rewards/blob/master/contracts/AirdropDistributor.sol

import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol";
import { IAddressProvider } from "@gearbox-protocol/core-v2/contracts/interfaces/IAddressProvider.sol";
import { IAirdropDistributor, DistributionData, ClaimedData } from "./interfaces/IAirdropDistributor.sol";
...
contract AirdropDistributor is Ownable, IAirdropDistributor {
	...
	constructor(address addressProvider, bytes32 merkleRoot_, ClaimedData[] memory alreadyClaimed) {
